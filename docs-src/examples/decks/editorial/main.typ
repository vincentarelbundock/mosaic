...
#styled(
  ...
  slide(
    layout: m.grids.columns(
      ...
      m.grids.track(0.45fr, c("agenda-photo", content: photo("image10.jpg"))),
    ),
  )[
    #set text(fill: ink)
    = AGENDA
...
#styled(
  ...
  slide(
    layout: m.grids.columns(
      ...
      m.grids.track(0.46fr, c("topic-photo", content: photo("image4.jpg"))),
    ),
    foreground: [#frame],
  )[
    = TOPIC
...
#styled(
  ...
  slide(layout: c("four-topics"), foreground: [#frame])[
    #grid(
      ...
      gutter: 12pt,
      row-gutter: 12pt,
      grid.cell(rowspan: 2, photo("image13.jpg")),
      ..range(1, 5).map(n => [
        == Topic #n
...
#styled(
  ...
  slide(
    layout: m.grids.columns(
      ...
      m.grids.track(0.33fr, c("cream-photo", content: photo("image7.jpg"))),
    ),
  )[
    #set text(fill: ink)
    #grid(
...
#styled(
  ...
  slide(layout: m.grids.columns(
    c("topic-two-photo", content: photo("image20.jpg")),
    c("topic-two-copy"),
  ))[
    #set text(fill: ink)
    = TOPIC 2
...
#styled(
  ...
  slide(layout: c("team"))[
    ...
    #grid(
      ...
      gutter: 0pt,
      ..(
        ("image31.jpg", "Jane Doe", "Director"),
        ("image35.jpg", "Jane Doe", "Marketing"),
        ("image36.jpg", "John Doe", "Sales"),
        ("image24.jpg", "Jane Doe", "PR"),
...
#styled(
  ...
  slide(layout: m.grids.columns(
    ...
    m.grids.track(0.36fr, c("projects-pattern", content: photo("image34.jpg"))),
  ), foreground: [#frame])[
    #grid(
      columns: (1fr, 1fr),
      rows: (1fr, 1fr),
...
#styled(
  ...
  slide(layout: m.grids.columns(
    ...
    m.grids.track(0.22fr, c("donut-photo", content: photo("image37.jpg"))),
  ), foreground: [#frame])[
    #align(center)[
      #v(1em)
      = MARKET RESEARCH
...
#styled(
  ...
  slide(layout: m.grids.columns(
    ...
    #grid(
      ...
      gutter: 5pt,
      row-gutter: 5pt,
      ..("image32.jpg", "image20.jpg", "image21.jpg", "image17.jpg", "image23.jpg",
        "image22.jpg", "image25.jpg", "image29.jpg", "image15.jpg").map(photo),
    )
  ],
)
...
#styled(
  ...
  slide(layout: m.grids.columns(
    m.grids.track(0.46fr, c("contact-photo", content: photo("image47.jpg"))),
