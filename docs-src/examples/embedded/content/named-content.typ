...
#show label("mosaic-cell-heading"): set block(fill: rgb("#e8f1fb"))
#show label("mosaic-cell-left"): set block(fill: rgb("#e8f5ec"))
#show label("mosaic-cell-right"): set block(fill: rgb("#f7f0dd"))
