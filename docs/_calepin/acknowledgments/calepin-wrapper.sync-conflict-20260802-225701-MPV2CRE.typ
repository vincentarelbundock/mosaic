...
#let _calepin-expected-generation = "dff74ca70f2836ae-1349cde127705c16"
...
Mosaic is small because it builds on ideas, tools, and design work shared by the
Typst community. This page records the sources that directly informed Mosaic's
implementation. Full copyright and license notices remain in
...
Credit goes to the Touying project and its contributors for demonstrating the
practical pre-slide snapshot and continuation-frame rewind technique.

Mosaic narrows that technique to explicitly selected objects and uses a lexical
pre-slide location suited to its own renderer. That avoids freezing unrelated
Typst or Mosaic state and keeps repeated logical slides convergence-safe.

The underlying problem and Typst's introspection model are further explained in
Laurenz Mädje's article
...
helped establish why presentation subframes need deliberate counter and state
semantics.

== Fitting utilities

Parts of Mosaic's explicit cell-fitting implementation are adapted from Touying
0.7.4 at the same pinned commit. Touying credits related work to Andreas
Kröpelin through
...
Attribution 4.0 International (CC BY 4.0)] license. The decks have been adapted,
and attribution is preserved here and in the full third-party license notices.
...
Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)] license. The adaptation
is offered under the same license.

== Toolchain

Mosaic is built with #link("https://typst.app/")[Typst]. Its documentation site
is generated with #link("https://github.com/vincentarelbundock/calepin")[Calepin]. We
are grateful to both projects and their contributors.
