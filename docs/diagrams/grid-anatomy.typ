...
#let diagram = cetz.canvas(length: 0.65cm, {
  ...
  line((-0.9, 3.55), (1.2, 3.1), stroke: blue, mark: arrow)

  content((13.5, 2.2), [*Cell 2*], anchor: "west")
  line((13.25, 2.1), (10.1, 2.0), stroke: blue, mark: arrow)

  content((3.5, -0.75), [*Inset*], anchor: "north")
  line((3.5, -0.5), (3.5, 0.27), stroke: blue, mark: arrow)
})
