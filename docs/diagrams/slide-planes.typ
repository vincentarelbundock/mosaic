...
#let diagram = cetz.canvas(length: 0.62cm, {
  ...
  let arrow = (end: "stealth", fill: blue, scale: 0.8)
  ...
  line((13.1, fg + 0.9), map(fg, W, H * 0.5), stroke: blue, mark: arrow)

  content((13.3, gr + 0.95), [*Grid*], anchor: "west")
  line((13.1, gr + 0.9), map(gr, W, H * 0.5), stroke: blue, mark: arrow)

  content((13.3, bg + 0.95), [*Background plane*], anchor: "west")
  line((13.1, bg + 0.9), map(bg, W, H * 0.5), stroke: blue, mark: arrow)
})
