...
#styled((cover: surface()), m.slide(
  ...
  foreground: [
    ...
    #styled(
      ...
      m.slide(
        layout: m.grids.columns(
          ...
          m.grids.track(0.64fr, cell("contents-image", content: photo("image13.png"))),
    ...
    #styled(
      ...
      m.slide(
        layout: m.grids.columns(
          ...
          m.grids.track(0.52fr, cell("hello-photo", content: photo("image21.png"))),
        ),
      )[
        #black-panel([
          #align(left)[
    ...
    #styled(
      ...
      m.slide(
        layout: m.grids.columns(
          m.grids.track(0.72fr, cell("pier", content: photo("image12.png"))),
          m.grids.track(0.72fr, cell("portrait", content: photo("image9.png"))),
    ...
    #styled(
      ...
      m.slide(
        layout: m.grids.columns(
          ...
          m.grids.track(0.7fr, cell("mission-photo", content: photo("image1.png"))),
        ),
      )[
...
#styled(
  ...
  m.slide(
    layout: m.grids.columns(
      ...
      m.grids.track(0.62fr, cell("best-photo", content: photo("image5.png"))),
