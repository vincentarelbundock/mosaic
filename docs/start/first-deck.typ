...
The #link("concepts.html")[Concepts] page defines the vocabulary this documentation uses, and #link("semantic-slide.html")[Semantic slide] builds a custom slide one layer at a time.
