// Shared record shape and validation primitives for semantic templates.
#import "shared.typ": tag, fail, reject-unknown-keys, valid-path

#let template-field-keys = (
  default: (
