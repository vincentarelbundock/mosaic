// Construction, validation, and resolution of the table template.
#import "grid-model.typ": styled-cell, v, t
#import "template-core.typ": make-grid, validate-role
#import "template-support.typ": fixed-text-cell
