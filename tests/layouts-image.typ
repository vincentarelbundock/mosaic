...
#assert(grid-test.info(left-grid, "image").cell.style.at("radius", default: 0pt) == 0pt)
...
#assert(grid-test.info(right-grid, "image").cell.style.at("radius", default: 0pt) == 0pt)
...
#assert(grid-test.info(top-grid, "image").cell.style.at("radius", default: 0pt) == 0pt)
...
#assert(grid-test.info(bottom-grid, "image").cell.style.at("radius", default: 0pt) == 0pt)
