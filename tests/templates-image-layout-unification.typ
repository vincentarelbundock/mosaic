...
#let title-right = resolve-template(title-right-command, settings)
...
#let section-left = resolve-template(section-left-command, settings)
...
#let section-right = resolve-template(mosaic.templates.section(
  variant: "image-right",
  image: section-image,
), settings)
...
#let section-top = resolve-template(mosaic.templates.section(
  variant: "image-top",
  image: section-image,
  tracks: (2fr, 1fr),
), settings)
...
#let section-bottom = resolve-template(mosaic.templates.section(
  variant: "image-bottom",
  image: section-image,
), settings)
...
#let section-background = resolve-template(mosaic.templates.section(
