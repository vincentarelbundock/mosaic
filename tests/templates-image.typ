...
#let full = mosaic.templates.image()
#let full-grid = resolve-template(full, settings)
...
#let path-full-grid = resolve-template(
  mosaic.templates.image(
...
#let figure-grid = resolve-template(
  mosaic.templates.image(
    variant: "figure",
    path: path("/docs/assets/images/dog.webp"),
    alt: "Dog",
...
#let left-grid = resolve-template(
  mosaic.templates.image(
    variant: "left",
    path: path("/docs/assets/images/dog.webp"),
    alt: "Dog",
...
#let right-grid = resolve-template(
  mosaic.templates.image(
    variant: "right",
    path: path("/docs/assets/images/dog.webp"),
    alt: "Dog",
...
#let bottom-grid = resolve-template(
  mosaic.templates.image(
    variant: "bottom",
    path: path("/docs/assets/images/dog.webp"),
    alt: "Dog",
...
#let top-auto = resolve-template(mosaic.templates.image(
  variant: "top",
  path: path("/docs/assets/images/dog.webp"),
), settings)
#assert(top-auto.tracks == (1fr, 1fr))

#let bottom-auto = resolve-template(mosaic.templates.image(
  variant: "bottom",
  path: path("/docs/assets/images/dog.webp"),
), settings)
#assert(bottom-auto.tracks == (1fr, 1fr))

#let consuming-left = resolve-template(mosaic.templates.image(
  variant: "left",
), settings)
...
#mosaic.slide(grid: mosaic.templates.image(
  variant: "figure",
  path: path("/docs/assets/images/dog.webp"),
  alt: "Dog",
))
